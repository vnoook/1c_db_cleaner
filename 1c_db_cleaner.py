# TODO
# сделать рефакторинг и добавить сравнение по содержимому файлов внутри папки с одинаковыми размерами файлов в байтах
    ...
    for folders, dirs, files in os.walk(folder_value):
        ...
        if flag_exist_ext:
            ...
            for file in files:
                ...
                print(list_big_files.sort())
                print(*list_big_files, sep='\n')
                print()
                print(*list_big_files[::-1], sep='\n')
                print()
