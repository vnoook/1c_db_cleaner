# TODO
# 1) добавить флаг сравниваемости — надо ли сравнивать или нет, при большом количестве quantity_files_in_dir
#    может быть большая нагрузке на файловую систему и комп в целом
...
# 4) добавить флаг закрываемости приложений, а также расширить их список
